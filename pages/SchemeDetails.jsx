      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {scheme === "JewelPlus" && lang === "en" && (
          <View>
            ...
            <Text style={styles.body}>The Jewel Plus Plan by G.S. Thanga Maligai is a specialized exchange scheme that allows you to turn your old gold or silver into new, hallmark jewellery with maximum value and zero making charges upon completion.</Text>
            <View style={styles.table}>
              <View style={styles.tableRow}><Text style={[styles.cell, styles.header]}>PROCESS</Text><Text style={[styles.cell, styles.header]}>STEP 1</Text><Text style={[styles.cell, styles.header]}>STEP 2</Text><Text style={[styles.cell, styles.header]}>STEP 3</Text></View>
              ...
              <Text style={styles.body}>The Jewel Plus Plan is available exclusively at our showroom and is only enrolled physically. Enrollment is not available online or through the mobile application. For further details or to join the scheme, we kindly invite you to visit your nearest G.S. Thanga Maligai showroom.</Text>
          </View>
        )}
        ...
        {scheme === "PonGold" && lang === "en" && (
          <View>
            ...
            <Text style={styles.body}>The 'Ponmagal Gold Scheme' by G.S. Thanga Maligai is a premier one-time investment plan. It is designed for those who prefer a lump-sum deposit over monthly installments, offering immediate gold credit and exceptional savings on final purchases.</Text>
            <View style={styles.table}>
              <View style={styles.tableRow}><Text style={[styles.cell, styles.header]}>PROCESS</Text><Text style={[styles.cell, styles.header]}>STEP 1</Text><Text style={[styles.cell, styles.header]}>STEP 2</Text><Text style={[styles.cell, styles.header]}>STEP 3</Text></View>
        ...
        {scheme === "PonSilver" && lang === "en" && (
          <View>
            ...
            <Text style={styles.body}>The 'Ponmagal Silver Scheme' by G.S. Thanga Maligai is a premier one-time investment plan. It is designed for those who prefer a lump-sum deposit over monthly installments, offering immediate silver credit and exceptional savings on final purchases.</Text>
            <View style={styles.table}>
              <View style={styles.tableRow}><Text style={[styles.cell, styles.header]}>PROCESS</Text><Text style={[styles.cell, styles.header]}>STEP 1</Text><Text style={[styles.cell, styles.header]}>STEP 2</Text><Text style={[styles.cell, styles.header]}>STEP 3</Text></View>
